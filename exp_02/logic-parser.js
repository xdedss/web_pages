...
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,3],$V1=[1,4],$V2=[1,5],$V3=[1,6],$V4=[1,8],$V5=[1,9],$V6=[1,10],$V7=[1,11],$V8=[5,6,7,8,9,11];
var parser = {trace: function trace() { },
yy: {},
symbols_: {"0":13,"1":14,"error":2,"expressions":3,"e":4,"EOF":5,"+":6,"*":7,"^":8,"'":9,"(":10,")":11,"ID":12,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",6:"+",7:"*",8:"^",9:"'",10:"(",11:")",12:"ID",13:"0",14:"1"},
productions_: [0,[3,2],[4,3],[4,3],[4,3],[4,2],[4,3],[4,1],[4,1],[4,1]],
...
table: [{3:1,4:2,10:$V0,12:$V1,13:$V2,14:$V3},{1:[3]},{5:[1,7],6:$V4,7:$V5,8:$V6,9:$V7},{4:12,10:$V0,12:$V1,13:$V2,14:$V3},o($V8,[2,7]),o($V8,[2,8]),o($V8,[2,9]),{1:[2,1]},{4:13,10:$V0,12:$V1,13:$V2,14:$V3},{4:14,10:$V0,12:$V1,13:$V2,14:$V3},{4:15,10:$V0,12:$V1,13:$V2,14:$V3},o($V8,[2,5]),{6:$V4,7:$V5,8:$V6,9:$V7,11:[1,16]},o([5,6,11],[2,2],{7:$V5,8:$V6,9:$V7}),o([5,6,7,11],[2,3],{8:$V6,9:$V7}),o([5,6,7,8,11],[2,4],{9:$V7}),o($V8,[2,6])],
